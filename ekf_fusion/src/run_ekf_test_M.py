...
def main():
    ...
    print("Loading trip 'M'...")
    raw_df = load_trip_for_fusion("M", base_path=base_path)
    ...
    out_path = os.path.join(base_path, "ekf_fusion", "output", "IDRFusedEstimate_M_blackout_test.csv")
    ...
    print(f"1. ZUPT Activity ({start_time - 30.0}s-{start_time}s): {zupt_pct:.2f}% of rows were stationary")
